...
$root.model = (function() {
    ...
    model.Tusach = (function() {

        /**
         * Constructs a new Tusach service.
         * @memberof model
         * @classdesc Represents a Tusach
         ...
         */
        function Tusach(rpcImpl, requestDelimited, responseDelimited) {
            $protobuf.rpc.Service.call(this, rpcImpl, requestDelimited, responseDelimited);
        }

        (Tusach.prototype = Object.create($protobuf.rpc.Service.prototype)).constructor = Tusach;

        /**
         * Creates new Tusach service using the specified rpc implementation.
         * @function create
         * @memberof model.Tusach
         * @static
         * @param {$protobuf.RPCImpl} rpcImpl RPC implementation
         * @param {boolean} [requestDelimited=false] Whether requests are length-delimited
         * @param {boolean} [responseDelimited=false] Whether responses are length-delimited
         * @returns {Tusach} RPC service. Useful where requests and/or responses are streamed.
         */
        Tusach.create = function create(rpcImpl, requestDelimited, responseDelimited) {
            return new this(rpcImpl, requestDelimited, responseDelimited);
        };

        /**
         * Callback as used by {@link model.Tusach#getBooks}.
         * @memberof model.Tusach
         * @typedef GetBooksCallback
         * @type {function}
         * @param {Error|null} error Error, if any
         * @param {model.BookList} [response] BookList
         */
         ...
         * @param {model.Tusach.GetBooksCallback} callback Node-style callback called with the error, if any, and BookList
         * @returns {undefined}
         * @variation 1
         */
        Object.defineProperty(Tusach.prototype.getBooks = function getBooks(request, callback) {
            return this.rpcCall(getBooks, $root.google.protobuf.Empty, $root.model.BookList, request, callback);
        }, "name", { value: "GetBooks" });
         ...
         * @instance
         * @param {google.protobuf.IEmpty} request Empty message or plain object
         * @returns {Promise<model.BookList>} Promise
         * @variation 2
         */

        /**
         * Callback as used by {@link model.Tusach#queryBooks}.
         * @memberof model.Tusach
         ...
         * @memberof model.Tusach
         * @instance
         * @param {model.IBookID} request BookID message or plain object
         * @param {model.Tusach.QueryBooksCallback} callback Node-style callback called with the error, if any, and BookList
         * @returns {undefined}
         * @variation 1
         */
        Object.defineProperty(Tusach.prototype.queryBooks = function queryBooks(request, callback) {
            return this.rpcCall(queryBooks, $root.model.BookID, $root.model.BookList, request, callback);
        }, "name", { value: "QueryBooks" });
        ...
        /**
         * Callback as used by {@link model.Tusach#getSystemInfo}.
         * @memberof model.Tusach
         * @typedef GetSystemInfoCallback
         * @type {function}
         * @param {Error|null} error Error, if any
         * @param {model.SystemInfo} [response] SystemInfo
         */
         ...
         * @instance
         * @param {google.protobuf.IEmpty} request Empty message or plain object
         * @param {model.Tusach.GetSystemInfoCallback} callback Node-style callback called with the error, if any, and SystemInfo
         * @returns {undefined}
         * @variation 1
         */
        Object.defineProperty(Tusach.prototype.getSystemInfo = function getSystemInfo(request, callback) {
            return this.rpcCall(getSystemInfo, $root.google.protobuf.Empty, $root.model.SystemInfo, request, callback);
         ...
         * @instance
         * @param {google.protobuf.IEmpty} request Empty message or plain object
         * @returns {Promise<model.SystemInfo>} Promise
         * @variation 2
         */

        /**
         * Callback as used by {@link model.Tusach#createBook}.
         * @memberof model.Tusach
         * @typedef CreateBookCallback
         * @type {function}
         * @param {Error|null} error Error, if any
         * @param {model.Book} [response] Book
         */
         ...
         * @memberof model.Tusach
         * @instance
         * @param {model.INewBookRequest} request NewBookRequest message or plain object
         * @param {model.Tusach.CreateBookCallback} callback Node-style callback called with the error, if any, and Book
         * @returns {undefined}
         * @variation 1
         */
        Object.defineProperty(Tusach.prototype.createBook = function createBook(request, callback) {
            return this.rpcCall(createBook, $root.model.NewBookRequest, $root.model.Book, request, callback);
         ...
         * @instance
         * @param {model.INewBookRequest} request NewBookRequest message or plain object
         * @returns {Promise<model.Book>} Promise
         * @variation 2
         */

        /**
         * Callback as used by {@link model.Tusach#updateBook}.
         * @memberof model.Tusach
         * @typedef UpdateBookCallback
         * @type {function}
         * @param {Error|null} error Error, if any
         * @param {model.Book} [response] Book
         */
         ...
         * @memberof model.Tusach
         * @instance
         * @param {model.IBook} request Book message or plain object
         * @param {model.Tusach.UpdateBookCallback} callback Node-style callback called with the error, if any, and Book
         * @returns {undefined}
         * @variation 1
         */
        Object.defineProperty(Tusach.prototype.updateBook = function updateBook(request, callback) {
            return this.rpcCall(updateBook, $root.model.Book, $root.model.Book, request, callback);
        }, "name", { value: "UpdateBook" });
        ...
        /**
         * Callback as used by {@link model.Tusach#deleteBook}.
         * @memberof model.Tusach
         * @typedef DeleteBookCallback
         * @type {function}
         * @param {Error|null} error Error, if any
         ...
         * @instance
         * @param {model.IBookID} request BookID message or plain object
         * @param {model.Tusach.DeleteBookCallback} callback Node-style callback called with the error, if any, and Empty
         * @returns {undefined}
         * @variation 1
         */
        Object.defineProperty(Tusach.prototype.deleteBook = function deleteBook(request, callback) {
            return this.rpcCall(deleteBook, $root.model.BookID, $root.google.protobuf.Empty, request, callback);
        }, "name", { value: "DeleteBook" });
